                        ...
                        <div class="product-card">
                            <div class="product-thumb">
                                <?php if($compaign_item->item->is_stock()): ?>
                                    <div
                                        class="product-badge
                            <?php if($compaign_item->item->is_type == 'feature'): ?> bg-warning
                            ...
                            ">
                                ...
                                <?php endif; ?>
                                <a href="<?php echo e(route('front.product', $compaign_item->item->slug)); ?>">
                                    <img src="<?php echo e(asset('assets/images/' . $compaign_item->item->thumbnail)); ?>"
                                        alt="Product">
                            ...
                            <div class="product-card-body">
                                ...
                                <h3 class="product-title"><a
                                        href="<?php echo e(route('front.product', $compaign_item->item->slug)); ?>">
...
<?php echo $__env->make('master.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Paquete-Express/resources/views/front/campaign.blade.php ENDPATH**/ ?>