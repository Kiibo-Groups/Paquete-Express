                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" id="descripcionsat"
                                ...
                                placeholder="Descripción" value="<?php echo e($item->descripcionsat); ?>" readonly>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" id="clavesat"
                                ...
                                placeholder="Clave" value="<?php echo e($item->clavesat); ?>" readonly >
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" id="unidadsat"
                                ...
                                placeholder="Unidad" value="<?php echo e($item->unidadsat); ?>" readonly>
                        </div>
                    </div>
...
<?php echo $__env->make('master.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\Paquete-Express\ecommerce\resources\views/back/item/edit.blade.php ENDPATH**/ ?>