...
<head>
    ...
    <link id="mainStyles" rel="stylesheet" media="screen" href="<?php echo e(url('/assets/front/css/styles.min.css')); ?>">
                        ...
                        <div class="nav-inner">
                            <nav class="site-menu">
                                <ul>
                                    ...
                                    <li class="t-h-dropdown">
                                        <a class="main-link" href="#"><?php echo e(__('Pages')); ?> <i
                                                class="icon-chevron-down"></i></a>
                                        <div class="t-h-dropdown-menu">
                                            <?php if($setting->is_faq == 1): ?>
                                                <a class="<?php echo e(request()->routeIs('front.faq*') ? 'active' : ''); ?>"
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <section class="widget widget-light-skin">
                        ...
                        <ul class="list-unstyled text-sm">
                            <li><span class=""><strong><?php echo e(__('Monday-Friday')); ?>:
                                    </strong></span><?php echo e($setting->friday_start); ?> - <?php echo e($setting->friday_end); ?></li>
                            <li><span class=""><strong><?php echo e(__('Saturday')); ?>:
                                    </strong></span><?php echo e($setting->satureday_start); ?> - <?php echo e($setting->satureday_end); ?>
                ...
                <div class="col-lg-4">
                    ...
                    <section class="widget">
                        ...
                        <div class="pt-3"><img class="d-block gateway_image"
                                src="<?php echo e($setting->footer_gateway_img ? asset('assets/images/' . $setting->footer_gateway_img) : asset('system/resources/assets/images/placeholder.png')); ?>">
                        </div>
                    </section>
                </div>
            </div>
...
<?php /**PATH C:\xampp2\htdocs\Paquete-Express\ecommerce\resources\views/master/front.blade.php ENDPATH**/ ?>