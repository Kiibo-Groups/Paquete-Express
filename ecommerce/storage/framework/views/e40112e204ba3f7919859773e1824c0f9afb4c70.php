                ...
                <form class="card" method="post" action="<?php echo e(route('user.login.submit')); ?>">
                    ...
                    <div class="card-body ">
                        ...
                        <div class="form-group input-group">
                            <input class="form-control" type="email" name="login_email" placeholder="<?php echo e(__('Email')); ?>"
                                value="<?php echo e(old('login_email')); ?>"><span class="input-group-addon"><i
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group input-group">
                            <input class="form-control" type="password" name="login_password"
                                placeholder="<?php echo e(__('Password')); ?>"><span class="input-group-addon"><i
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="text-center">
                            <button class="btn btn-primary margin-bottom-none"
                                type="submit"><span><?php echo e(__('Login')); ?></span></button>
                        </div>
                        <div class="row">
                            <div class="col-lg-12 text-center mt-3">
                                <?php if($setting->facebook_check == 1): ?>
                                    <a class="facebook-btn mr-2"
                                        href="<?php echo e(route('social.provider', 'facebook')); ?>"><?php echo e(__('Facebook login')); ?>

                                    </a>
                                <?php endif; ?>
                                <?php if($setting->google_check == 1): ?>
                                    <a class="google-btn" href="<?php echo e(route('social.provider', 'google')); ?>">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="first_name"
                                        placeholder="<?php echo e(__('First Name')); ?>" id="reg-fn"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="last_name"
                                            placeholder="<?php echo e(__('Last Name')); ?>" id="reg-ln" value="<?php echo e(old('last_name')); ?>">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="colonia_envio"
                                            placeholder="<?php echo e(__('Colonia Envío')); ?>" id="reg-ln" value="<?php echo e(old('colonia_envio')); ?>">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="localidad_envio"
                                            placeholder="<?php echo e(__('Localidad Envío')); ?>" id="reg-ln" value="<?php echo e(old('localidad_envio')); ?>">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="municipio_envio"
                                            placeholder="<?php echo e(__('Municipio de Envío')); ?>" id="reg-ln" value="<?php echo e(old('municipio_envio')); ?>">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="estado_envio"
                                            placeholder="<?php echo e(__('Estado de Envío')); ?>" id="reg-ln" value="<?php echo e(old('estado_envio')); ?>">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="email" name="email"
                                                placeholder="<?php echo e(__('E-mail Address')); ?>" id="reg-email"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="phone" type="text"
                                                    placeholder="<?php echo e(__('Phone Number')); ?>" id="reg-phone" value="<?php echo e(old('phone')); ?>">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="password" name="password"
                                                        placeholder="<?php echo e(__('Password')); ?>" id="reg-pass">
...
$message = $__bag->first($__errorArgs[0]); ?>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="password" name="password_confirmation"
                                                            placeholder="<?php echo e(__('Confirm Password')); ?>" id="reg-pass-confirm">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12 text-center">
                                                    <button class="btn btn-primary margin-bottom-none"
                                                        type="submit"><span><?php echo e(__('Register')); ?></span></button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
...
<?php echo $__env->make('master.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\Paquete-Express\ecommerce\resources\views/user/auth/login.blade.php ENDPATH**/ ?>