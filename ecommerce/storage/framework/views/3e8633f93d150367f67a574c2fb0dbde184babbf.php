    ...
    <div class="row">
      <div class="col-lg-4 col-md-5 col-sm-5 order-lg-1 order-md-2 order-sm-2">
        ...
        <section class="widget widget-featured-posts card rounded p-4" style="height: 500px" >
            ...
            <iframe src="https://maps.google.com/maps?q=<?php echo e($setting->footer_address); ?>" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>    
        </section>
      </div>
...
<?php echo $__env->make('master.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\Paquete-Express\ecommerce\resources\views/front/contact.blade.php ENDPATH**/ ?>