                ...
                <form class="card" method="post" action="{{ route('user.login.submit') }}">
                    ...
                    <div class="card-body ">
                        ...
                        <div class="form-group input-group">
                            <input class="form-control" type="email" name="login_email" placeholder="{{ __('Email') }}"
                                value="{{ old('login_email') }}"><span class="input-group-addon"><i
                        ...
                        <div class="row">
                            <div class="col-lg-12 text-center mt-3">
                                ...
                                @if ($setting->google_check == 1)
                                    <a class="google-btn" href="{{ route('social.provider', 'google') }}">
                                        {{ __('Google login') }}
                                    </a>
                                @endif
                            </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="colonia_envio"
                                            placeholder="{{ __('Colonia Envío') }}" id="reg-ln" value="{{ old('colonia_envio') }}">
                                        @error('colonia_envio')
                                            <p class="text-danger">{{ $message }}</p>
                                            @endif
                                        </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="localidad_envio"
                                            placeholder="{{ __('Localidad Envío') }}" id="reg-ln" value="{{ old('localidad_envio') }}">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="municipio_envio"
                                            placeholder="{{ __('Municipio de Envío') }}" id="reg-ln" value="{{ old('municipio_envio') }}">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="estado_envio"
                                            placeholder="{{ __('Estado de Envío') }}" id="reg-ln" value="{{ old('estado_envio') }}">
                                        @error('estado_envio')
                                            <p class="text-danger">{{ $message }}</p>
                                            @endif
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="col-12 text-center">
                                                    <button class="btn btn-primary margin-bottom-none"
                                                        type="submit"><span>{{ __('Register') }}</span></button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
