                        ...
                        <form id="billingForm" class="row" action="{{ route('user.billing.submit') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="bill_address2"
                                    value="{{ $user->bill_address2 }}" id="billing-address2">
                                @error('bill_address2')
                                    <p class="text-danger">{{ $message }}</p>
                                    @endif
                                </div>
                                                        ...
                                                        <select class="form-control" name="bill_country" id="billing-country">
                                                            ...
                                                            @foreach (DB::table('countries')->get() as $country)
                                                                <option value="{{ $country->name }}"
                                                                    {{ $user->bill_country == $country->name ? 'selected' : '' }}>
                                                                    {{ $country->name }}</option>
                                                            @endforeach
                                                        </select>
                                                        @error('bill_country')
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" type="text"
                                                                placeholder="{{ __('Referencia de dirección de envío') }}"
                                                                name="referencia_direccion_envio" id="billing-company"
                                                                value="{{ $user->referencia_direccion_envio }}">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" type="text" placeholder="{{ __('Clave Pais SAT') }}"
                                                                    name="clave_pais" id="billing-company" value="{{ $user->clave_pais }}">
                                                                @error('clave_pais')
                                                                    <p class="text-danger">{{ $message }}</p>
                                                                    @endif
                                                                </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" type="text" placeholder="{{ __('Forma de pago SAT') }}"
                                                                        name="forma_pago_sat" id="billing-company" value="{{ $user->forma_pago_sat }}">
                                                                ...
                                                                <div class="col-12 ">
                                                                    <div class="text-right">
                                                                        <button class="btn btn-primary margin-bottom-none  btn-sm"
                                                                            type="submit"><span>{{ __('Update Address') }}</span></button>
                                                                    </div>
                                                                </div>
                                                            </form>
                                                        ...
                                                        <form id="shippingForm" class="row" action="{{ route('user.shipping.submit') }}"
                                                                method="POST">
                                                                                @csrf
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input class="form-control" name="ship_address1" value="{{ $user->ship_address1 }}"
                                                                                    ...
                                                                                    <div class="col-md-6">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <input class="form-control" value="{{ $user->ship_address2 }}" name="ship_address2"
                                                                                            ...
                                                                                            <div class="col-md-6">
                                                                                                ...
                                                                                                <div class="col-md-6">
                                                                                                    ...
                                                                                                    @if (DB::table('states')->count() > 0)
                                                                                                        <div class="col-md-6">
                                                                                                            <div class="form-group">
                                                                                                                <label for="state_id">{{ __('State') }}
                                                                                                                    <small>({{ __('include tax') }})</small> </label>
                                                                                            ...
                                                                                            <div class="{{ DB::table('states')->count() > 0 ? 'col-md-12' : 'col-md-6' }} ">
                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <select class="form-control" name="ship_country" id="shipping-country">
                                                                                                        ...
                                                                                                        @foreach (DB::table('countries')->get() as $country)
                                                                                                            <option value="{{ $country->name }}"
                                                                                                                {{ $user->ship_country == $country->name ? 'selected' : '' }}>{{ $country->name }}
                                                                                                            </option>
                                                                                                        @endforeach
                                                                                                    </select>
                                                                                                    @error('ship_country')
