        ...
        <div class="card card-body p-5">
            <div class="row">
                <div class="col-lg-12">
                    <a href="<?php echo e(route('user.order.index')); ?>"
                        class="btn btn-sm btn-primary d-inline-block"><span><?php echo e(__('Back')); ?></span></a>
                    <a href="<?php echo e(route('user.order.print', $order->id)); ?>" target="_blank"
                        class="btn btn-sm btn-primary invoice_price d-inline-block"><span><?php echo e(__('Print')); ?></span></a>
                </div>
            </div> <!-- / .row -->
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    ...
                    ?>
                    <span class="text-muted"><?php echo e(__('Name')); ?>: </span><?php echo e($ship['ship_first_name']); ?>

                    <?php echo e($ship['ship_last_name']); ?> <br>
                    ...
                    <?php if(isset($ship['ship_address1'])): ?>
                        <span class="text-muted"><?php echo e(__('Address')); ?>: </span><?php echo e($ship['ship_address1']); ?>,
                        <?php echo e(isset($ship['ship_address2']) ? $ship['ship_address2'] : ''); ?><br>
                    <?php endif; ?>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="px-0 bg-transparent border-top-0">
                                        <span class="h6">Descripción SAT</span>
                                    </th>
                                    <th class="px-0 bg-transparent border-top-0">
                                        <span class="h6">Clave SAT</span>
                                    </th>
                                    <th class="px-0 bg-transparent border-top-0">
                                        <span class="h6">Unidad SAT</span>
                                    </th>
                                    <th class="px-0 bg-transparent border-top-0">
                            ...
                            <tbody>
                                ...
                                <?php $__currentLoopData = json_decode($order->cart, true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                                ...
                                                <?php if($main_item): ?>
                                                    <?php if($item['item_type'] == 'digital'): ?>
                                                        <?php if($order->payment_status == 'Paid'): ?>
                                                            <?php if($main_item['file_type'] == 'link'): ?>
                                                                <a href="<?php echo e($main_item->link); ?>" target="_blank"
                                                                    class="btn btn-sm btn-success"><?php echo e(__('Click Here')); ?></a>
                                                            <?php else: ?>
                                                                <a href="<?php echo e(asset('assets/files/' . $main_item->file)); ?>"
                                                                    class="btn btn-sm btn-success"><?php echo e(__('Download')); ?></a>
                                                            <?php endif; ?>
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                                    ...
                                                    <?php if($item['item_type'] == 'license'): ?>
                                                        <?php if($order->payment_status == 'Paid'): ?>
                                                            <?php if($main_item['file_type'] == 'link'): ?>
                                                                <a href="<?php echo e($main_item->link); ?>" target="_blank"
                                                                    class="btn btn-sm my-2 btn-success"><?php echo e(__('Click Here')); ?></a>
                                                                <p class="py-2"><?php echo e(__('License Information')); ?> :
                                                                    <?php echo e($item['item_l_n']); ?> : <?php echo e($item['item_l_k']); ?></p>
                                                            <?php else: ?>
                                                                <a href="<?php echo e(asset('assets/files/' . $main_item->file)); ?>"
                                                                    class="btn my-2 btn-sm btn-success"><?php echo e(__('Download')); ?></a>
                                                                <p class="py-2"><?php echo e(__('License Information')); ?> :
                                                                    <?php echo e($item['item_l_n']); ?> : <?php echo e($item['item_l_k']); ?></p>
                                                            <?php endif; ?>
                                                        <?php endif; ?>
                                        ...
                                        <td class="px-0">
                                            <?php echo e($main_item['descripcionsat']); ?>

                                        </td>

                                        <td class="px-0">
                                            <?php echo e($main_item['clavesat']); ?>

                                        </td>

                                        <td class="px-0">
                                            <?php echo e($main_item['unidadsat']); ?>
                                        ...
                                        <td class="px-0 text-right border-top border-top-2" colspan="5">
                                            <span>
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <?php echo e(round($order['state_price'] * $order->currency_value, 2)); ?><?php echo e($order->currency_sign); ?>
...
<?php echo $__env->make('master.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Paquete-Express/resources/views/user/order/invoice.blade.php ENDPATH**/ ?>