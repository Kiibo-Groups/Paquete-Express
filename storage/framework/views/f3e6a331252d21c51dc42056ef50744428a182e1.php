                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" type="text"
                                                                placeholder="<?php echo e(__('Referencia de dirección de envío')); ?>"
                                                                name="referencia_direccion_envio" id="billing-company"
                                                                value="<?php echo e($user->referencia_direccion_envio); ?>">
...
$message = $__bag->first($__errorArgs[0]); ?>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" type="text" placeholder="<?php echo e(__('Clave Pais SAT')); ?>"
                                                                    name="clave_pais" id="billing-company" value="<?php echo e($user->clave_pais); ?>">
...
$message = $__bag->first($__errorArgs[0]); ?>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" type="text" placeholder="<?php echo e(__('Forma de pago SAT')); ?>"
                                                                        name="forma_pago_sat" id="billing-company" value="<?php echo e($user->forma_pago_sat); ?>">
...
$message = $__bag->first($__errorArgs[0]); ?>
                                                        ...
                                                        <form id="shippingForm" class="row" action="<?php echo e(route('user.shipping.submit')); ?>"
                                                                method="POST">
                                                                                <?php echo csrf_field(); ?>
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
...
$message = $__bag->first($__errorArgs[0]); ?>
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input class="form-control" name="ship_address1" value="<?php echo e($user->ship_address1); ?>"
                                                                                            type="text" id="shipping-address1">
...
$message = $__bag->first($__errorArgs[0]); ?>
                                                                                    ...
                                                                                    <div class="col-md-6">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <input class="form-control" value="<?php echo e($user->ship_address2); ?>" name="ship_address2"
                                                                                                type="text" id="shipping-address2">
...
$message = $__bag->first($__errorArgs[0]); ?>
                                                                                            ...
                                                                                            <div class="col-md-6">
                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <input class="form-control" type="text" name="ship_city" id="shippingcity"
                                                                                                        value="<?php echo e($user->ship_city); ?>">
...
$message = $__bag->first($__errorArgs[0]); ?>
                                                                                                ...
                                                                                                <div class="col-md-6">
                                                                                                    <div class="form-group">
                                                                                                        ...
                                                                                                        <input class="form-control" type="text" name="ship_company" id="shipping-company"
                                                                                                            value="<?php echo e($user->ship_company); ?>">
...
$message = $__bag->first($__errorArgs[0]); ?>
                                                                                                    ...
                                                                                                    <?php if(DB::table('states')->count() > 0): ?>
                                                                                                        <div class="col-md-6">
                                                                                                            <div class="form-group">
                                                                                                                <label for="state_id"><?php echo e(__('State')); ?>

                                                                                                                    <small>(<?php echo e(__('include tax')); ?>)</small> </label>
                                                                                                                <select class="form-control" name="state_id" id="state_id">
                                                                                                                    ...
                                                                                                                    <?php $__currentLoopData = DB::table('states')->whereStatus(1)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $state): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                                                        <option value="<?php echo e($state->id); ?>"
                                                                                                                            <?php echo e($user->state_id == $state->id ? 'selected' : ''); ?>>
                                                                                            ...
                                                                                            <div class="<?php echo e(DB::table('states')->count() > 0 ? 'col-md-12' : 'col-md-6'); ?> ">
                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <select class="form-control" name="ship_country" id="shipping-country">
                                                                                                        ...
                                                                                                        <?php $__currentLoopData = DB::table('countries')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                                            <option value="<?php echo e($country->name); ?>"
                                                                                                                <?php echo e($user->ship_country == $country->name ? 'selected' : ''); ?>><?php echo e($country->name); ?>
...
<?php echo $__env->make('master.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Paquete-Express/resources/views/user/dashboard/address.blade.php ENDPATH**/ ?>